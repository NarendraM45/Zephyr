...
class _$LocationEntityImpl implements _LocationEntity {
  ...
  @override
  String toString() {
    return 'LocationEntity(name: $name, region: $region, country: $country, lat: $lat, lon: $lon, localtime: $localtime, tzId: $tzId)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, name, region, country, lat, lon, localtime, tzId);
...
abstract class _LocationEntity implements LocationEntity {
  const factory _LocationEntity(
      ...
      required final String tzId}) = _$LocationEntityImpl;
